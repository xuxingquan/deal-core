...
public class Salary {
	...
	public static final Double wuxian = 21396.0;/* 五险的基数 ,如果有需要的自己修改 */
	public static final Double gongjin = 21400.0;/* 公积金的基数,如果有需要的自己修改 */
	...
	public static void latesalary(Double salary) {
		...
		Double wuxianjin = wuxian * 0.08/* 养老保险 */+ wuxian * 0.02/* 医疗保险 */
				+ wuxian * 0.005/* 医疗保险 */+ gongjin * 0.07/* 公积金 */;
		...
		if (qizhengdian == Double.parseDouble("3500")) {
			...
			if (salary <= 1500) { /* (0,1500] */
				...
				geshui = (1500 * 0.03) + (3000 * 0.10) + (4500) * 0.20
						+ (salary - 9000) * 0.25;
			} else if (salary <= 55000) {/* [35000,55000] */
				geshui = (1500 * 0.03) + (3000 * 0.10) + (4500) * 0.20 + 26000
						* 0.25 + (salary - 35000) * 0.30;
			} else if (salary <= 80000) {/* [55000,80000] */
				geshui = (1500 * 0.03) + (3000 * 0.10) + (4500) * 0.20 + 26000
						* 0.25 + 20000 * 0.30 + (salary - 55000) * 0.35;
			} else {/* 80000+ */
				geshui = (1500 * 0.03) + (3000 * 0.10) + (4500) * 0.20 + 26000
						* 0.25 + 20000 * 0.30 + 25000 * 0.35 + (salary - 80000)
						* 0.45;
			}
		...
		if (qizhengdian == Double.parseDouble("5000")) {
			...
			if (salary <= 3000) {
				...
				geshui = 3000 * 0.03 + 9000 * 0.10 + 13000 * 0.20
						+ (salary - 25000) * 0.25;
			} else if (salary <= 55000) {
				geshui = 3000 * 0.03 + 9000 * 0.10 + 13000 * 0.20 + 10000
						* 0.25 + (salary - 35000) * 0.30;
